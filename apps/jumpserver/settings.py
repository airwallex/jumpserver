...
OIDC_RP_IDP_SIGN_KEY = CONFIG.OIDC_RP_IDP_SIGN_KEY
OIDC_OP_JWKS_ENDPOINT = CONFIG.OIDC_OP_JWKS_ENDPOINT
LOGIN_REDIRECT_URL = CONFIG.LOGIN_REDIRECT_URL
LOGOUT_REDIRECT_URL = CONFIG.LOGOUT_REDIRECT_URL
OIDC_USERNAME_ALGO = lambda email: email.lower()
OIDC_AUTHENTICATION_BACKENDS = [
    'mozilla_django_oidc.auth.OIDCAuthenticationBackend',
]

if AUTH_OIDC:
    AUTHENTICATION_BACKENDS.insert(0, OIDC_AUTHENTICATION_BACKENDS[0])
